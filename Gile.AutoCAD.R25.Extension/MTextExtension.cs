...
namespace Gile.AutoCAD.R25.Extension
{
    ...
    public static class MTextExtension
    {
        ...
        /// <exception cref="ArgumentNullException">Thrown if <paramref name ="mtext"/> is null.</exception>
        public static Point3d[] GetMTextBoxCorners(this MText mtext)
        {
            ArgumentNullException.ThrowIfNull(mtext);
        ...
        public static void Mirror(this MText source, Transaction tr, Line3d axis, bool eraseSource)
        {
